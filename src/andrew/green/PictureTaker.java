...
public class PictureTaker extends Activity {
	...
	/*
	 * PictureCallback rawCallback = new PictureCallback() { // <7> public void
	 * onPictureTaken(byte[] data, Camera camera) { data = null; System.gc();
	...
	PictureCallback jpegCallback = new PictureCallback() { // <8>
		...
		public void onPictureTaken(byte[] data, Camera camera) {
			...
			/*
			 * if (portrait){ try{ final BitmapFactory.Options options = new
			 * BitmapFactory.Options(); options.inJustDecodeBounds = true;
			 * //BitmapFactory.decodeByteArray(data,0,data.length);
			 * 
			 * options.inSampleSize =
			 * 2;//Converter.calculateInSampleSize(options, 500, 500);
			 * 
			 ...
			 * 
			 * 
			 * //bitmap.getPixels(i,0,bitmap.getWidth(),0,0,bitmap.getWidth(),bitmap
			 * .getHeight());
			 * 
			 * data=null; System.gc(); if (h>=w){ ByteArrayOutputStream stream =
			 * new ByteArrayOutputStream();
			 * b.compress(Bitmap.CompressFormat.JPEG, 100, stream);
			 * bitmapdata=new byte[length]; bitmapdata = stream.toByteArray();
			 * b.recycle(); } }catch (OutOfMemoryError e){
			 * 
			 * 
			 * 
			 ...
			 * 
			 * options.inSampleSize =
			 * 8;//Converter.calculateInSampleSize(options, 500, 500);
			 * 
			 * options.inJustDecodeBounds = false;
			 * 
			 * Bitmap
			 ...
			 * data=null; System.gc(); if (h>=w){ ByteArrayOutputStream stream =
			 * new ByteArrayOutputStream();
			 * b.compress(Bitmap.CompressFormat.JPEG, 100, stream); bitmapdata =
			 * stream.toByteArray(); b.recycle(); }
			 * 
			 * 
			 * 
			 * 
			 ...
			 * 
			 * 
			 * }//end portrait // int count=0; // while (count<i.length){ //
			 * data[count]=(byte) i[count]; // count++; // }
			 */
			...
			try {
				...
				if (portrait)
					outStream.write(Converter.rotate(data)); // output the image
				if (!portrait)
				...
				if (a == 1) {
					...
					Intent intent = new Intent(PictureTaker.this,
							MainActivity.class);
					Log.d("a", "intent made");
					// message.show();
